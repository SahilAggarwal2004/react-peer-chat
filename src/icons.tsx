...
export function BiSolidMessageDetail(props: React.DetailedHTMLProps<React.HTMLAttributes<HTMLSpanElement>, HTMLSpanElement>) {
    return <span className='rpc-icon-container' {...props}>
...
export function BsFillMicFill(props: React.DetailedHTMLProps<React.HTMLAttributes<HTMLSpanElement>, HTMLSpanElement>) {
    return <span className='rpc-icon-container' {...props}>
...
export function BsFillMicMuteFill(props: React.DetailedHTMLProps<React.HTMLAttributes<HTMLSpanElement>, HTMLSpanElement>) {
    return <span className='rpc-icon-container' {...props}>
        <svg fill="currentColor" width='1rem' height='1rem'>
